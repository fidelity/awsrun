...
from awsrun.acctload import CSVAccountLoader, IdentityAccountLoader, JSONAccountLoader
...
class CSV(JSON):
    ...
    become the attribute names on the loaded account objects. Given the
    following CSV file:
